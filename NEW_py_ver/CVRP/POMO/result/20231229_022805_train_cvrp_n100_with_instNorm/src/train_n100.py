...
trainer_params = {
    ...
    'model_load': {
        ...
        'path': './result/20231225_144238_train_cvrp_n100_with_instNorm',  # directory path of pre-trained model and log files saved.
        'epoch': 6500,  # epoch version of pre-trained model to laod.
